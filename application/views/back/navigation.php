		...
		<div class="nano">
			<div class="nano-content">
				<ul id="mainnav-menu" class="list-group">
					...
					{ ?>
						<li <?php if($page_name=="free_members"||$page_name=="premium_members"|| $page_name == "deleted_member" || $page_name=="add_member" || $page_name=="bulk_member_add" ){ ?> class="active-sub active" <?php } ?>>
							<a href="#">
